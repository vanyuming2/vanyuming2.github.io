...
test("exports the complete original-data life-remake loop", async () => {
  ...
  assert.match(game, /includeTalentId: progress\.inheritedTalentId/);
  ...
  assert.match(specialEndings, /"21305"/);
  ...
  assert.match(game, /availableTruthEventAge\(scheduledEvents\)/);
